    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background_color', models.CharField(default='rgba(108,71,255,.2)', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#1a2744', max_length=20)),
                ('pill_class', models.CharField(default='pill-purple', max_length=30)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(default='CS Department', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(default='1h', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('lesson_type', models.CharField(choices=[('video', 'Video'), ('reading', 'Reading'), ('lab', 'Lab'), ('quiz', 'Quiz')], default='video', max_length=20)),
                ('duration', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quizzes', to='api.course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(choices=[('pdf', 'PDF'), ('video', 'Video'), ('image', 'Image'), ('text', 'Text'), ('link', 'Link'), ('default', 'Other')], default='default', max_length=20)),
                ('size', models.CharField(default='0 B', max_length=30)),
